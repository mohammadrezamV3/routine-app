...
// برای نوتیف واقعی حتی وقتی اپ کاملا بسته‌ست، به service worker + push
// subscription + یک زمان‌بند سمت سرور نیاز داریم که فعلا این پروژه نداره.
 ...
 * برای یادآوری‌هایی که یک روز چند نوبت دارن (مثل دارو)، خود نوبت باید توی
 * کلید بیاد — مثلا `med:<id>:480` — تا هر نوبت جدا شمرده بشه. */
