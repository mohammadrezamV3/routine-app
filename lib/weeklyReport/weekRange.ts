...
// تنها منبع محاسبه‌ی «هفته» توی کل فیچر گزارش هفتگی — بقیه‌ی فایل‌ها
// همیشه از همین استفاده می‌کنن، نه اینکه خودشون startOfWeek بزنن.
//
// چرا نمی‌شه مستقیم startOfWeek(new Date()) زد: سرور معمولا UTC اجراست،
// پس نزدیک نیمه‌شب، «امروز سرور» می‌تونه یک روز با «امروز کاربر» فرق کنه
// و هفته اشتباه محاسبه بشه. اول تاریخ روز جاری رو با Intl به وقت محلی
// کاربر می‌گیریم، بعد یک Date با همون سال/ماه/روز (نه ساعت) می‌سازیم —
// چون روز هفته فقط به تاریخ تقویمی بستگی داره، نه به ساعت.
...
/**
 * بازه‌ی هفته (شنبه تا جمعه) به‌وقت محلی کاربر. weekOffset=0 یعنی هفته‌ی
 * جاری، -1 یعنی هفته‌ی قبل، و... . weekStart/weekEnd هردو ساعت ۰۰:۰۰
...
/** آرایه‌ی ۷ تاریخ شنبه..جمعه‌ی همون هفته، برای Daily Breakdown. */
...
/** آیا این weekOffset به هفته‌ی جاری یا آینده اشاره می‌کنه — انتخاب هفته‌ی آینده مجاز نیست. */
