...
/**
 * N هفته‌ی متوالی قبل از fromOffset (هرکدوم شامل متریک‌های دامنه + شکست
 * روزانه). هم برای میانگین ۴هفته‌ی V1، هم Baseline V3، هم Trend/Correlation
 * V2 از همین یک منبع مشترک استفاده می‌کنن — تا محاسبه‌ی هفته دوباره‌کاری نشه.
 */
