...
export type ExerciseItemSpec = {
  baseName: string;
  sets: number;
  /** true یعنی هر ست/کلِ حرکت با شمارش‌معکوسِ زمانی انجام می‌شه (پلانک، کاردیو)، نه با تکرارِ شمارشی */
  isTimed: boolean;
  /** برای حرکاتِ تکرارمحور: تعدادِ تکرارِ هر ست (مثلاً «۶» توی «۴×۶») */
  reps: string | null;
  /** برای حرکاتِ زمان‌محور: طولِ هر ست/کلِ حرکت به ثانیه (مثلاً پلانکِ ۳۰ ثانیه‌ای، یا دویدنِ ۲۵ دقیقه‌ای) */
  seconds: number | null;
};
...
/** متنِ خامِ یک آیتمِ برنامه رو به اجزاش (اسم/تعدادِ ست/تکرار یا زمان) می‌شکنه — برای نمایشِ جدولی و تشخیصِ حرکاتِ زمان‌محور */
