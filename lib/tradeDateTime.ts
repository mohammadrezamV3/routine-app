// تبدیل‌های زمان ماژول ترید.
//
// قرارداد: در دیتابیس همیشه UTC ذخیره می‌شود؛ در UI همیشه ساعت محلی خود
// مرورگر کاربر نشان داده و گرفته می‌شود. این فایل تنها جایی است که این دو
...
/** مقدار فیلد فرم → ISO UTC برای ارسال به سرور */
...
/** بخش تاریخ یک مقدار فرم (برای دیت‌پیکر) */
