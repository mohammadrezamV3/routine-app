...
- هر عضله‌ی هدف حداقل ۳ حرکتِ متمایز (نه تکراری، نه وارم‌آپ) داشته باشد. تعداد حرکات ثابت یا از پیش
  تعیین‌شده نیست — نتیجه‌ی حجم تمرینی موردنیاز، عضلات هدف، سطح کاربر، هدف، زمان جلسه و ریکاوری است، اما
  هیچ‌وقت از این حداقل کمتر نرود.
- اگر یک عضله به حرکات بیشتری نیاز دارد، حرکات کافی اضافه کن؛ اگر حرکت اضافه باعث حجم غیرضروری می‌شود، اضافه نکن.
- هیچ جلسه‌ای را صرفا برای کوتاه کردن خروجی به چند حرکت محدود نکن، ولی حجم را عملی نگه دار — معمولا از
  ۱۰ تا ۱۵ حرکت در یک جلسه بیشتر نشو مگر واقعا لازم باشد.
