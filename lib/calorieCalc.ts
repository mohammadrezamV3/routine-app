...
// کفِ ایمنیِ کالری روزانه. کسرِ ۲۰٪ برای هدفِ «کاهش وزن» روی یک فردِ ریز و
// کم‌تحرک می‌تونه هدف رو ببره *زیرِ* خودِ BMR — یعنی زیرِ کالریِ لازم برای
// کارکردِ پایه‌ی بدن در حالتِ استراحت. سقفِ قبلی (`Math.max(1000, ...)`) هم
// یک عددِ ثابت بود که برای هیچ‌کس واقعاً محافظت نمی‌کرد. حالا دو کف داریم:
// (۱) هیچ‌وقت زیرِ BMR، (۲) هیچ‌وقت زیرِ حداقلِ رایجِ ایمنِ بالینی
