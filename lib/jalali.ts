...
//
// چرا سال اول نوشته می‌شه در حالی که ترتیبِ خواسته‌شده «روز/ماه/سال» است:
// این رشته یک دنباله‌ی خالصِ رقم و اسلش است، پس الگوریتم دوجهته‌ی مرورگر
// همیشه چپ‌به‌راست رندرش می‌کند — حتی داخلِ صفحه‌ی RTL. یعنی چیزی که کاربر
// از **راست** می‌خواند دقیقاً برعکسِ ترتیبِ نوشتنِ ماست: با نوشتنِ
// سال/ماه/روز، خواندن از راست می‌شود روز، ماه، سال — همان که پلیس‌هولدرِ
// «روز / ماه / سال» هم وعده می‌دهد. حالتِ قبلی (روز اول) دقیقاً برعکس دیده می‌شد.
