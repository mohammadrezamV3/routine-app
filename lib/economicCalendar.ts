...
//   • هیچ فید رایگانی برای استفاده‌ی تجاری مجوز روشن ندارد و هاردکد‌کردن
//     یک منبع، هم حقوقی و هم عملیاتی شکننده است.
//
// وقتی یک فید واقعی خریداری/تنظیم شد، فقط `ECONOMIC_CALENDAR_URL` (و در
// صورت نیاز `ECONOMIC_CALENDAR_API_KEY`) ست می‌شود و کران روزانه همان را
// نرمال‌سازی و در همین جدول ذخیره می‌کند. هیچ‌جای دیگر اپ عوض نمی‌شود.
