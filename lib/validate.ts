 ...
 *
 * چرا لازم است: کیبوردِ فارسیِ اندروید و ویندوز «۰۹۱۲…» تایپ می‌کند، ولی
 * هر جای دیگری (regexِ اعتبارسنجی، ذخیره در دیتابیس، مقایسه با کدِ OTP)
 * فقط رقمِ لاتین می‌فهمد. بدونِ این، کاربر عددِ درست وارد می‌کرد و پیامِ
 * «شماره نامعتبر است» می‌گرفت — و هیچ راهی نداشت بفهمد چرا.
 *
 * ارقامِ عربیِ شرقی (٠١٢…) هم پوشش داده می‌شوند چون بعضی کیبوردها
 * به‌جای فارسی همان‌ها را می‌فرستند و ظاهرشان تقریباً یکی است.
 */
...
/** فقط رقم نگه می‌دارد و ارقامِ فارسی/عربی را هم اول لاتین می‌کند */
