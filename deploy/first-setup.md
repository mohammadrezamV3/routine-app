...
> **راهِ یک‌دستوری:** اگر نمی‌خواهی مرحله‌به‌مرحله جلو بروی، کلِ این سند در
> `deploy/bootstrap.sh` خودکار شده است:
>
> ```bash
> ssh root@<SERVER_IP>
...
> ```
>
> چند سؤال می‌پرسد (دامنه، ایمیل، یوزرنیم/رمز ادمین) و بقیه را خودش انجام
> می‌دهد. idempotent است: اگر وسطش قطع شد، دوباره اجرا کن. ادامه‌ی این سند
> برای وقتی‌ست که می‌خواهی بدانی هر مرحله دقیقا چه می‌کند یا دستی جلو بروی.
