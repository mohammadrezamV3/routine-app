...
- تقویم اقتصادی همیشه از جدول خودمون خونده می‌شه، نه مستقیم از سرویس بیرونی (CSP اجازه نمی‌ده و نباید به یه سرویس خارجی گره بخوره). بدون هیچ فیدی، با ورود دستی ادمین کار می‌کنه؛ با ست‌کردن `ECONOMIC_CALENDAR_URL` کران روزانه upsert می‌کنه.
