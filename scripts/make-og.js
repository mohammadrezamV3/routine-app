// تصویر اشتراک‌گذاری (Open Graph) — `node scripts/make-og.js`.
// قبلا `og:image` اصلا وجود نداشت، یعنی هر لینکی که در تلگرام/واتساپ/
// توییتر به اشتراک گذاشته می‌شد یک کارت بی‌تصویر بود. لوگو نسبت ابعاد
// بنر (۱۲۰۰×۶۳۰) رو نداره، پس این‌جا روی پس‌زمینه‌ی تم تاریک ترکیب می‌شه.
