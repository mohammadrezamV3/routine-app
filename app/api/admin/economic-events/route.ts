...
// مدیریتِ دستیِ رویدادهای اقتصادی. تا وقتی هیچ فیدِ خارجی تنظیم نشده،
// همین مسیر تنها راهِ پرکردنِ تقویم است — و حتی بعد از تنظیمِ فید هم برای
// اصلاح/افزودنِ دستی باقی می‌ماند (رویدادهای دستی با source=MANUAL از
// همگام‌سازیِ خودکار دست‌نخورده می‌مانند).
