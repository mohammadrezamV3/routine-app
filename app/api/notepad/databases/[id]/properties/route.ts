...
// POST /api/notepad/databases/:id/properties — افزودن property جدید
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  if (!VALID_TYPES.has(type as any)) return NextResponse.json({ error: "نوع property نامعتبره" }, { status: 400 });
