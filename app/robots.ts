...
// فقط صفحاتِ عمومیِ بازاریابی/محتوایی قابل کراله؛ همه‌چیزِ دیگه (داشبوردِ
// شخصیِ کاربر، پنل ادمین، فرم‌های auth، API) نباید crawl بشه — چون یا
  ...
  return {
    rules: {
      ...
      disallow: [
        ...
        "/notepad",
        "/notepad/",
        // خودِ /subscription پشتِ AuthGate ـه (کاربرِ مهمان فقط پیامِ «وارد
        // شو» می‌بینه، نه جدولِ پلن‌ها) — جدولِ واقعیِ پلن‌ها که عمومیه از
