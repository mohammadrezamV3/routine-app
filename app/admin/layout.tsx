...
// این پنل دیتای خصوصیِ کسب‌وکار (کاربران، تراکنش‌ها) رو نشون می‌ده — علاوه
// بر X-Robots-Tag توی next.config.js و notFound() پایین (که اصلاً محتوایی
// به غیرِ سوپرادمین نمی‌ده)، این هم یه لایه‌ی اضافه‌ست.
