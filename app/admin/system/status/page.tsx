  ...
  return (
    <section>
      ...
      <div className="admin-section-hint">
        متریک‌های CPU/Disk سطحِ زیرساخت (نه پردازه) این‌جا نمایش داده نمی‌شن چون این محیط به مانیتورینگِ واقعیِ سرورِ production متصل نیست — طبقِ قاعده‌ی «هیچ داده‌ای Fake نشه». حافظه/Uptime/Load بالا واقعی و از خودِ پردازه‌ی در حالِ اجرا خونده می‌شن.
      </div>
    </section>
  );
}
