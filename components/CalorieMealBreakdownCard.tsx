...
// «کالری هر وعده» — از کارت «کالری امروز» جدا شده و کارت بزرگ‌تر خودش رو
// داره، چون تعداد وعده‌ها متغیره (۲ تا ۶ تا) و توی یه باکس کوچیک جا نمی‌شد.
// ویرایش وعده‌ها دیگه اینجا نیست — از پاپ‌آپ «تغییر برنامه» (حالت دستی)
  ...
  return (
    <DashCard delay={delay} className="p-3 sm:p-4">
      ...
      {/* سه باکس در هر ردیف حتی روی موبایل (درخواست صریح کاربر) — پس
          خود باکس‌ها جمع‌وجورتر شدن تا جا بشن. */}
      <div className="mt-2.5 grid grid-cols-3 gap-1.5 sm:gap-2.5">
