// کدِ رسمیِ نمادِ اعتماد الکترونیکی — دقیقاً همون snippetی که پنلِ اینماد
// برای این سایت صادر کرده (id/Code مخصوصِ این دامنه‌ست، دست‌کاری نکن).
// alt رو (برخلافِ خروجیِ خامِ اینماد که alt='' می‌ده) یه متنِ معنادار گذاشتم
