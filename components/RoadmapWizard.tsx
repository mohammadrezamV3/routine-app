...
const BUILD_LINES = [
  "دارم خواسته‌ات رو می‌شکافم…",
  "دارم مشخص می‌کنم چه حوزه‌هایی و با چه ترتیبی باید بخونی…",
  "دارم جلسه‌ها رو دقیقاً به اندازه‌ی وقتی که داری می‌بُرم…",
  "دارم منابع و مدرک‌های واقعی رو انتخاب می‌کنم…",
