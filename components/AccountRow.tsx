...
// ردیفِ استاندارد پنل کاربری — یا لینک به یه زیرصفحه‌ست (chevron)، یا یه
// سوییچِ دودویی این‌جا خودِ همین ردیف عوض می‌شه. هردو حالت دقیقاً همون
// آیکون-در-دایره‌ی نرم + عنوان/توضیح رو دارن؛ فقط سمتِ کنترل فرق می‌کنه.
// stagger با delay بر پایه‌ی index — ورودِ مرحله‌ای وقتی چند ردیف کنارِ هم‌ان.
function RowShell({
  index,
  icon,
  label,
