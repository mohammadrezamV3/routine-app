...
// پاپ‌آپ «جابه‌جاکردن» — لیست همه‌ی صفحات غیرآرشیوشده (به‌جز خود صفحه و
// زیرمجموعه‌هاش، که سرور هم دوباره چکش می‌کنه) برای انتخاب والد جدید؛
// گزینه‌ی «سطح اصلی» هم برای بردن صفحه به ریشه
