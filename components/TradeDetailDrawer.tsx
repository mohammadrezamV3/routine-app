...
// جزئیاتِ کاملِ یک معامله. عمداً کشویی (نه صفحه‌ی جدا): کاربر معمولاً چند
// معامله را پشتِ‌سرِهم مرور می‌کند و برگشتن به لیست نباید هربار یک ناوبریِ
// کامل باشد. تصاویر و اسنپ‌شاتِ چک‌لیست فقط همین‌جا (نه در لیست) لود می‌شوند.
