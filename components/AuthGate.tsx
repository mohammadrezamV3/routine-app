...
// وقتی کاربرِ مهمون (لاگین‌نکرده) میاد سراغِ یه بخشِ نیازمندِ حساب (ورزش/ترید)
// — عیناً هم‌زبانِ بصریِ ModuleGate (پیش‌نمایشِ تارِ اسکلتی + پیام + دکمه)
// ولی برای «وارد نشدن» نه «اشتراک نداشتن». بعدِ ورود، خودِ ModuleGate
// تصمیمِ دسترسیِ ماژول رو می‌گیره — این گیت جایگزینش نمی‌شه، فقط قبلش می‌شینه.
