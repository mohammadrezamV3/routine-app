...
export const useAudioAmplitude = (
  ...
  // نسخه‌ی اصلی `Float32Array<ArrayBuffer>` داشت؛ در TS 5.9 امضای
  // getFloatTimeDomainData دقیقا همان نوع را می‌خواهد، پس همان را نگه می‌داریم.
  ...
  }, [fftSize, JSON.stringify(constraints ?? null)]);
  ...
  return { amplitude, start, status, stop, stream };
};
