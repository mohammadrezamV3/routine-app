...
// پورتِ عینِ components/MuscleDiagram.tsx وب — همون مسیرهای SVG دست‌ساز،
// همون گرادیانِ طلایی برای عضله‌ی فعال. فقط "use client" حذف شده (این‌جا
// Vite SPA است، همه چیز کلاینتی است).
...
function DiagramView({ view, active }: { view: "front" | "back"; active: Set<MuscleKey> }) {
  return (
    <svg viewBox="0 0 120 210" width="100%" height="100%" style={{ maxWidth: 110 }}>
      <BodySilhouette />
